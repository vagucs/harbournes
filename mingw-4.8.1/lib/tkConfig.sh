...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/src/pkg/tk-8.6.0-1-mingw32-src/bld -ltk86'
...
# compiled.
TK_SRC_DIR='/usr/src/pkg/tk-8.6.0-1-mingw32-src/tk8.6.0-src'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/src/pkg/tk-8.6.0-1-mingw32-src/bld -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/mingw/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/src/pkg/tk-8.6.0-1-mingw32-src/bld/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/mingw/lib/libtkstub86.a'
