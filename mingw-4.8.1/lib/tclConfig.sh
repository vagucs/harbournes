...
TCL_EXTRA_CFLAGS=' -DTCL_BROKEN_MAINARGS -pipe'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/usr/src/pkg/tcl-8.6.0-1-mingw32-src/bld -ltcl86'
...
# compiled.
TCL_SRC_DIR='/usr/src/pkg/tcl-8.6.0-1-mingw32-src/tcl8.6.0-src'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/mingw/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/usr/src/pkg/tcl-8.6.0-1-mingw32-src/bld -ltclstub86'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/mingw/lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/usr/src/pkg/tcl-8.6.0-1-mingw32-src/bld/libtclstub86.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/mingw/lib/libtclstub86.a'
