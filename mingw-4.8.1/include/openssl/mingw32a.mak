...
PLATFORM=Mingw32
CC=gcc
CFLAG=-DL_ENDIAN -DDSO_WIN32 -fomit-frame-pointer -O3 -march=i486 -Wall -DBN_ASM -DMD5_ASM -DSHA1_ASM -DOPENSSL_BN_ASM_PART_WORDS -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_SEED -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_TLSEXT -DOPENSSL_NO_CMS -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE    
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
APP_EX_OBJ=
...
HEADER=$(INCL_D)/e_os.h \
	...
	$(INCL_D)/testdsa.h $(INCL_D)/testrsa.h $(INCL_D)/e_4758cca_err.c \
...
EXHEADER=$(INCO_D)/e_os2.h \
	$(INCO_D)/crypto.h $(INCO_D)/tmdiff.h $(INCO_D)/opensslv.h \
	...
	$(INCO_D)/conf_api.h $(INCO_D)/txt_db.h $(INCO_D)/pkcs7.h \
	...
	$(INCO_D)/ssl3.h $(INCO_D)/ssl23.h $(INCO_D)/tls1.h \
...
SSLOBJ=$(OBJ_D)/s2_meth.o \
	...
	$(OBJ_D)/t1_enc.o $(OBJ_D)/d1_meth.o $(OBJ_D)/d1_srvr.o \
...
CRYPTOOBJ=$(OBJ_D)/cryptlib.o \
	...
	$(OBJ_D)/tmdiff.o $(OBJ_D)/cpt_err.o $(OBJ_D)/ebcdic.o \
	...
	$(OBJ_D)/rc2ofb64.o $(RC4_ENC_OBJ) $(OBJ_D)/rc4_skey.o \
	...
	$(OBJ_D)/aes_wrap.o $(OBJ_D)/aes_core.o $(OBJ_D)/aes_cbc.o \
	$(OBJ_D)/bn_add.o $(OBJ_D)/bn_div.o $(OBJ_D)/bn_exp.o \
	$(OBJ_D)/bn_lib.o $(OBJ_D)/bn_ctx.o $(OBJ_D)/bn_mul.o \
	$(OBJ_D)/bn_mod.o $(OBJ_D)/bn_print.o $(OBJ_D)/bn_rand.o \
	$(OBJ_D)/bn_shift.o $(OBJ_D)/bn_word.o $(OBJ_D)/bn_blind.o \
	$(OBJ_D)/bn_kron.o $(OBJ_D)/bn_sqrt.o $(OBJ_D)/bn_gcd.o \
	$(OBJ_D)/bn_prime.o $(OBJ_D)/bn_err.o $(OBJ_D)/bn_sqr.o \
	$(BN_ASM_OBJ) $(OBJ_D)/bn_recp.o $(OBJ_D)/bn_mont.o \
	$(OBJ_D)/bn_mpi.o $(OBJ_D)/bn_exp2.o $(OBJ_D)/bn_gf2m.o \
	$(OBJ_D)/bn_nist.o $(OBJ_D)/bn_depr.o $(OBJ_D)/bn_const.o \
	$(OBJ_D)/rsa_eay.o $(OBJ_D)/rsa_gen.o $(OBJ_D)/rsa_lib.o \
	$(OBJ_D)/rsa_sign.o $(OBJ_D)/rsa_saos.o $(OBJ_D)/rsa_err.o \
	$(OBJ_D)/rsa_pk1.o $(OBJ_D)/rsa_ssl.o $(OBJ_D)/rsa_none.o \
	$(OBJ_D)/rsa_oaep.o $(OBJ_D)/rsa_chk.o $(OBJ_D)/rsa_null.o \
	$(OBJ_D)/rsa_pss.o $(OBJ_D)/rsa_x931.o $(OBJ_D)/rsa_asn1.o \
	$(OBJ_D)/rsa_depr.o $(OBJ_D)/dsa_gen.o $(OBJ_D)/dsa_key.o \
	$(OBJ_D)/dsa_lib.o $(OBJ_D)/dsa_asn1.o $(OBJ_D)/dsa_vrf.o \
	$(OBJ_D)/dsa_sign.o $(OBJ_D)/dsa_err.o $(OBJ_D)/dsa_ossl.o \
	$(OBJ_D)/dsa_depr.o $(OBJ_D)/dso_dl.o $(OBJ_D)/dso_dlfcn.o \
	$(OBJ_D)/dso_err.o $(OBJ_D)/dso_lib.o $(OBJ_D)/dso_null.o \
	$(OBJ_D)/dso_openssl.o $(OBJ_D)/dso_win32.o $(OBJ_D)/dso_vms.o \
	$(OBJ_D)/dh_asn1.o $(OBJ_D)/dh_gen.o $(OBJ_D)/dh_key.o \
	$(OBJ_D)/dh_lib.o $(OBJ_D)/dh_check.o $(OBJ_D)/dh_err.o \
	$(OBJ_D)/dh_depr.o $(OBJ_D)/ec_lib.o $(OBJ_D)/ecp_smpl.o \
	$(OBJ_D)/ecp_mont.o $(OBJ_D)/ecp_nist.o $(OBJ_D)/ec_cvt.o \
	$(OBJ_D)/ec_mult.o $(OBJ_D)/ec_err.o $(OBJ_D)/ec_curve.o \
	$(OBJ_D)/ec_check.o $(OBJ_D)/ec_print.o $(OBJ_D)/ec_asn1.o \
	$(OBJ_D)/ec_key.o $(OBJ_D)/ec2_smpl.o $(OBJ_D)/ec2_mult.o \
	$(OBJ_D)/ech_lib.o $(OBJ_D)/ech_ossl.o $(OBJ_D)/ech_key.o \
	$(OBJ_D)/ech_err.o $(OBJ_D)/ecs_lib.o $(OBJ_D)/ecs_asn1.o \
	$(OBJ_D)/ecs_ossl.o $(OBJ_D)/ecs_sign.o $(OBJ_D)/ecs_vrf.o \
	$(OBJ_D)/ecs_err.o $(OBJ_D)/buffer.o $(OBJ_D)/buf_err.o \
	...
	$(OBJ_D)/bf_nbio.o $(OBJ_D)/bss_log.o $(OBJ_D)/bss_bio.o \
	$(OBJ_D)/bss_dgram.o $(OBJ_D)/stack.o $(OBJ_D)/lhash.o \
	$(OBJ_D)/lh_stats.o $(OBJ_D)/md_rand.o $(OBJ_D)/randfile.o \
	$(OBJ_D)/rand_lib.o $(OBJ_D)/rand_err.o $(OBJ_D)/rand_egd.o \
	$(OBJ_D)/rand_win.o $(OBJ_D)/rand_unix.o $(OBJ_D)/rand_os2.o \
	$(OBJ_D)/rand_nw.o $(OBJ_D)/err.o $(OBJ_D)/err_all.o \
	...
	$(OBJ_D)/evp_acnf.o $(OBJ_D)/e_des.o $(OBJ_D)/e_bf.o \
	$(OBJ_D)/e_idea.o $(OBJ_D)/e_des3.o $(OBJ_D)/e_rc4.o \
	$(OBJ_D)/e_aes.o $(OBJ_D)/names.o $(OBJ_D)/e_xcbc_d.o \
	$(OBJ_D)/e_rc2.o $(OBJ_D)/e_cast.o $(OBJ_D)/e_rc5.o \
	$(OBJ_D)/m_null.o $(OBJ_D)/m_md2.o $(OBJ_D)/m_md4.o \
	$(OBJ_D)/m_md5.o $(OBJ_D)/m_sha.o $(OBJ_D)/m_sha1.o \
	$(OBJ_D)/m_dss.o $(OBJ_D)/m_dss1.o $(OBJ_D)/m_ripemd.o \
	$(OBJ_D)/m_ecdsa.o $(OBJ_D)/p_open.o $(OBJ_D)/p_seal.o \
	...
	$(OBJ_D)/e_null.o $(OBJ_D)/c_all.o $(OBJ_D)/c_allc.o \
	$(OBJ_D)/c_alld.o $(OBJ_D)/evp_lib.o $(OBJ_D)/bio_ok.o \
	$(OBJ_D)/evp_pkey.o $(OBJ_D)/evp_pbe.o $(OBJ_D)/p5_crpt.o \
	$(OBJ_D)/p5_crpt2.o $(OBJ_D)/e_old.o $(OBJ_D)/a_object.o \
	$(OBJ_D)/a_bitstr.o $(OBJ_D)/a_utctm.o $(OBJ_D)/a_gentm.o \
	$(OBJ_D)/a_time.o $(OBJ_D)/a_int.o $(OBJ_D)/a_octet.o \
	$(OBJ_D)/a_print.o $(OBJ_D)/a_type.o $(OBJ_D)/a_set.o \
	$(OBJ_D)/a_dup.o $(OBJ_D)/a_d2i_fp.o $(OBJ_D)/a_i2d_fp.o \
	$(OBJ_D)/a_enum.o $(OBJ_D)/a_utf8.o $(OBJ_D)/a_sign.o \
	$(OBJ_D)/a_digest.o $(OBJ_D)/a_verify.o $(OBJ_D)/a_mbstr.o \
	$(OBJ_D)/a_strex.o $(OBJ_D)/x_algor.o $(OBJ_D)/x_val.o \
	$(OBJ_D)/x_pubkey.o $(OBJ_D)/x_sig.o $(OBJ_D)/x_req.o \
	$(OBJ_D)/x_attrib.o $(OBJ_D)/x_bignum.o $(OBJ_D)/x_long.o \
	$(OBJ_D)/x_name.o $(OBJ_D)/x_x509.o $(OBJ_D)/x_x509a.o \
	$(OBJ_D)/x_crl.o $(OBJ_D)/x_info.o $(OBJ_D)/x_spki.o \
	$(OBJ_D)/nsseq.o $(OBJ_D)/d2i_pu.o $(OBJ_D)/d2i_pr.o \
	$(OBJ_D)/i2d_pu.o $(OBJ_D)/i2d_pr.o $(OBJ_D)/t_req.o \
	$(OBJ_D)/t_x509.o $(OBJ_D)/t_x509a.o $(OBJ_D)/t_crl.o \
	$(OBJ_D)/t_pkey.o $(OBJ_D)/t_spki.o $(OBJ_D)/t_bitst.o \
	$(OBJ_D)/tasn_new.o $(OBJ_D)/tasn_fre.o $(OBJ_D)/tasn_enc.o \
	$(OBJ_D)/tasn_dec.o $(OBJ_D)/tasn_utl.o $(OBJ_D)/tasn_typ.o \
	$(OBJ_D)/f_int.o $(OBJ_D)/f_string.o $(OBJ_D)/n_pkey.o \
	$(OBJ_D)/f_enum.o $(OBJ_D)/a_hdr.o $(OBJ_D)/x_pkey.o \
	$(OBJ_D)/a_bool.o $(OBJ_D)/x_exten.o $(OBJ_D)/asn_mime.o \
	$(OBJ_D)/asn1_gen.o $(OBJ_D)/asn1_par.o $(OBJ_D)/asn1_lib.o \
	$(OBJ_D)/asn1_err.o $(OBJ_D)/a_meth.o $(OBJ_D)/a_bytes.o \
	$(OBJ_D)/a_strnid.o $(OBJ_D)/evp_asn1.o $(OBJ_D)/asn_pack.o \
	$(OBJ_D)/p5_pbe.o $(OBJ_D)/p5_pbev2.o $(OBJ_D)/p8_pkey.o \
	$(OBJ_D)/asn_moid.o $(OBJ_D)/pem_sign.o $(OBJ_D)/pem_seal.o \
	$(OBJ_D)/pem_info.o $(OBJ_D)/pem_lib.o $(OBJ_D)/pem_all.o \
	$(OBJ_D)/pem_err.o $(OBJ_D)/pem_x509.o $(OBJ_D)/pem_xaux.o \
	$(OBJ_D)/pem_oth.o $(OBJ_D)/pem_pk8.o $(OBJ_D)/pem_pkey.o \
	$(OBJ_D)/x509_def.o $(OBJ_D)/x509_d2.o $(OBJ_D)/x509_r2x.o \
	$(OBJ_D)/x509_cmp.o $(OBJ_D)/x509_obj.o $(OBJ_D)/x509_req.o \
	$(OBJ_D)/x509spki.o $(OBJ_D)/x509_vfy.o $(OBJ_D)/x509_set.o \
	$(OBJ_D)/x509cset.o $(OBJ_D)/x509rset.o $(OBJ_D)/x509_err.o \
	$(OBJ_D)/x509name.o $(OBJ_D)/x509_v3.o $(OBJ_D)/x509_ext.o \
	$(OBJ_D)/x509_att.o $(OBJ_D)/x509type.o $(OBJ_D)/x509_lu.o \
	$(OBJ_D)/x_all.o $(OBJ_D)/x509_txt.o $(OBJ_D)/x509_trs.o \
	$(OBJ_D)/by_file.o $(OBJ_D)/by_dir.o $(OBJ_D)/x509_vpm.o \
	$(OBJ_D)/v3_bcons.o $(OBJ_D)/v3_bitst.o $(OBJ_D)/v3_conf.o \
	$(OBJ_D)/v3_extku.o $(OBJ_D)/v3_ia5.o $(OBJ_D)/v3_lib.o \
	$(OBJ_D)/v3_prn.o $(OBJ_D)/v3_utl.o $(OBJ_D)/v3err.o \
	$(OBJ_D)/v3_genn.o $(OBJ_D)/v3_alt.o $(OBJ_D)/v3_skey.o \
	$(OBJ_D)/v3_akey.o $(OBJ_D)/v3_pku.o $(OBJ_D)/v3_int.o \
	$(OBJ_D)/v3_enum.o $(OBJ_D)/v3_sxnet.o $(OBJ_D)/v3_cpols.o \
	$(OBJ_D)/v3_crld.o $(OBJ_D)/v3_purp.o $(OBJ_D)/v3_info.o \
	$(OBJ_D)/v3_ocsp.o $(OBJ_D)/v3_akeya.o $(OBJ_D)/v3_pmaps.o \
	$(OBJ_D)/v3_pcons.o $(OBJ_D)/v3_ncons.o $(OBJ_D)/v3_pcia.o \
	$(OBJ_D)/v3_pci.o $(OBJ_D)/pcy_cache.o $(OBJ_D)/pcy_node.o \
	$(OBJ_D)/pcy_data.o $(OBJ_D)/pcy_map.o $(OBJ_D)/pcy_tree.o \
	$(OBJ_D)/pcy_lib.o $(OBJ_D)/v3_asid.o $(OBJ_D)/v3_addr.o \
	$(OBJ_D)/conf_err.o $(OBJ_D)/conf_lib.o $(OBJ_D)/conf_api.o \
	$(OBJ_D)/conf_def.o $(OBJ_D)/conf_mod.o $(OBJ_D)/conf_mall.o \
	$(OBJ_D)/conf_sap.o $(OBJ_D)/txt_db.o $(OBJ_D)/pk7_asn1.o \
	$(OBJ_D)/pk7_lib.o $(OBJ_D)/pkcs7err.o $(OBJ_D)/pk7_doit.o \
	$(OBJ_D)/pk7_smime.o $(OBJ_D)/pk7_attr.o $(OBJ_D)/pk7_mime.o \
	$(OBJ_D)/p12_add.o $(OBJ_D)/p12_asn.o $(OBJ_D)/p12_attr.o \
	$(OBJ_D)/p12_crpt.o $(OBJ_D)/p12_crt.o $(OBJ_D)/p12_decr.o \
	$(OBJ_D)/p12_init.o $(OBJ_D)/p12_key.o $(OBJ_D)/p12_kiss.o \
	$(OBJ_D)/p12_mutl.o $(OBJ_D)/p12_utl.o $(OBJ_D)/p12_npas.o \
	$(OBJ_D)/pk12err.o $(OBJ_D)/p12_p8d.o $(OBJ_D)/p12_p8e.o \
	$(OBJ_D)/comp_lib.o $(OBJ_D)/comp_err.o $(OBJ_D)/c_rle.o \
	$(OBJ_D)/c_zlib.o $(OBJ_D)/eng_err.o $(OBJ_D)/eng_lib.o \
	$(OBJ_D)/eng_list.o $(OBJ_D)/eng_init.o $(OBJ_D)/eng_ctrl.o \
	$(OBJ_D)/eng_table.o $(OBJ_D)/eng_pkey.o $(OBJ_D)/eng_fat.o \
	$(OBJ_D)/eng_all.o $(OBJ_D)/tb_rsa.o $(OBJ_D)/tb_dsa.o \
	$(OBJ_D)/tb_ecdsa.o $(OBJ_D)/tb_dh.o $(OBJ_D)/tb_ecdh.o \
	$(OBJ_D)/tb_rand.o $(OBJ_D)/tb_store.o $(OBJ_D)/tb_cipher.o \
	$(OBJ_D)/tb_digest.o $(OBJ_D)/eng_openssl.o $(OBJ_D)/eng_cnf.o \
	$(OBJ_D)/eng_dyn.o $(OBJ_D)/eng_cryptodev.o $(OBJ_D)/eng_padlock.o \
	$(OBJ_D)/ocsp_asn.o $(OBJ_D)/ocsp_ext.o $(OBJ_D)/ocsp_ht.o \
	$(OBJ_D)/ocsp_lib.o $(OBJ_D)/ocsp_cl.o $(OBJ_D)/ocsp_srv.o \
	$(OBJ_D)/ocsp_prn.o $(OBJ_D)/ocsp_vfy.o $(OBJ_D)/ocsp_err.o \
	$(OBJ_D)/ui_err.o $(OBJ_D)/ui_lib.o $(OBJ_D)/ui_openssl.o \
	$(OBJ_D)/ui_util.o $(OBJ_D)/ui_compat.o $(OBJ_D)/krb5_asn.o \
	$(OBJ_D)/str_err.o $(OBJ_D)/str_lib.o $(OBJ_D)/str_meth.o \
	$(OBJ_D)/str_mem.o $(OBJ_D)/pqueue.o $(OBJ_D)/e_4758cca.o \
	$(OBJ_D)/e_aep.o $(OBJ_D)/e_atalla.o $(OBJ_D)/e_cswift.o \
	$(OBJ_D)/e_gmp.o $(OBJ_D)/e_chil.o $(OBJ_D)/e_nuron.o \
	$(OBJ_D)/e_sureware.o $(OBJ_D)/e_ubsec.o $(BNCO_ASM_OBJ) 
...
$(INCO_D)/tmdiff.h: $(SRC_D)/crypto/tmdiff.h
	$(CP) "$(SRC_D)/crypto/tmdiff.h" "$(INCO_D)/tmdiff.h"
...
$(INCO_D)/txt_db.h: $(SRC_D)/crypto/txt_db/txt_db.h
	$(CP) "$(SRC_D)/crypto/txt_db/txt_db.h" "$(INCO_D)/txt_db.h"
...
$(INCO_D)/tls1.h: $(SRC_D)/ssl/tls1.h
	$(CP) "$(SRC_D)/ssl/tls1.h" "$(INCO_D)/tls1.h"
...
$(OBJ_D)/nseq.o: $(SRC_D)/apps/nseq.c
	$(CC) -o $(OBJ_D)/nseq.o -DMONOLITH $(APP_CFLAGS) -c $(SRC_D)/apps/nseq.c
...
$(OBJ_D)/cms.o: $(SRC_D)/apps/cms.c
	$(CC) -o $(OBJ_D)/cms.o -DMONOLITH $(APP_CFLAGS) -c $(SRC_D)/apps/cms.c
...
$(OBJ_D)/aes_wrap.o: $(SRC_D)/crypto/aes/aes_wrap.c
	$(CC) -o $(OBJ_D)/aes_wrap.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/aes/aes_wrap.c
...
$(OBJ_D)/nsseq.o: $(SRC_D)/crypto/asn1/nsseq.c
	$(CC) -o $(OBJ_D)/nsseq.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/nsseq.c
...
$(OBJ_D)/t_x509a.o: $(SRC_D)/crypto/asn1/t_x509a.c
	$(CC) -o $(OBJ_D)/t_x509a.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/t_x509a.c

$(OBJ_D)/t_crl.o: $(SRC_D)/crypto/asn1/t_crl.c
	$(CC) -o $(OBJ_D)/t_crl.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/t_crl.c

$(OBJ_D)/t_pkey.o: $(SRC_D)/crypto/asn1/t_pkey.c
	$(CC) -o $(OBJ_D)/t_pkey.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/t_pkey.c

$(OBJ_D)/t_spki.o: $(SRC_D)/crypto/asn1/t_spki.c
	$(CC) -o $(OBJ_D)/t_spki.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/t_spki.c

$(OBJ_D)/t_bitst.o: $(SRC_D)/crypto/asn1/t_bitst.c
	$(CC) -o $(OBJ_D)/t_bitst.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/t_bitst.c

$(OBJ_D)/tasn_new.o: $(SRC_D)/crypto/asn1/tasn_new.c
	$(CC) -o $(OBJ_D)/tasn_new.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_new.c

$(OBJ_D)/tasn_fre.o: $(SRC_D)/crypto/asn1/tasn_fre.c
	$(CC) -o $(OBJ_D)/tasn_fre.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_fre.c

$(OBJ_D)/tasn_enc.o: $(SRC_D)/crypto/asn1/tasn_enc.c
	$(CC) -o $(OBJ_D)/tasn_enc.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_enc.c

$(OBJ_D)/tasn_dec.o: $(SRC_D)/crypto/asn1/tasn_dec.c
	$(CC) -o $(OBJ_D)/tasn_dec.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_dec.c

$(OBJ_D)/tasn_utl.o: $(SRC_D)/crypto/asn1/tasn_utl.c
	$(CC) -o $(OBJ_D)/tasn_utl.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_utl.c

$(OBJ_D)/tasn_typ.o: $(SRC_D)/crypto/asn1/tasn_typ.c
	$(CC) -o $(OBJ_D)/tasn_typ.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/tasn_typ.c
...
$(OBJ_D)/asn_mime.o: $(SRC_D)/crypto/asn1/asn_mime.c
	$(CC) -o $(OBJ_D)/asn_mime.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/asn1/asn_mime.c
...
$(OBJ_D)/tb_rsa.o: $(SRC_D)/crypto/engine/tb_rsa.c
	$(CC) -o $(OBJ_D)/tb_rsa.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_rsa.c

$(OBJ_D)/tb_dsa.o: $(SRC_D)/crypto/engine/tb_dsa.c
	$(CC) -o $(OBJ_D)/tb_dsa.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_dsa.c

$(OBJ_D)/tb_ecdsa.o: $(SRC_D)/crypto/engine/tb_ecdsa.c
	$(CC) -o $(OBJ_D)/tb_ecdsa.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_ecdsa.c

$(OBJ_D)/tb_dh.o: $(SRC_D)/crypto/engine/tb_dh.c
	$(CC) -o $(OBJ_D)/tb_dh.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_dh.c

$(OBJ_D)/tb_ecdh.o: $(SRC_D)/crypto/engine/tb_ecdh.c
	$(CC) -o $(OBJ_D)/tb_ecdh.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_ecdh.c

$(OBJ_D)/tb_rand.o: $(SRC_D)/crypto/engine/tb_rand.c
	$(CC) -o $(OBJ_D)/tb_rand.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_rand.c

$(OBJ_D)/tb_store.o: $(SRC_D)/crypto/engine/tb_store.c
	$(CC) -o $(OBJ_D)/tb_store.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_store.c

$(OBJ_D)/tb_cipher.o: $(SRC_D)/crypto/engine/tb_cipher.c
	$(CC) -o $(OBJ_D)/tb_cipher.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_cipher.c

$(OBJ_D)/tb_digest.o: $(SRC_D)/crypto/engine/tb_digest.c
	$(CC) -o $(OBJ_D)/tb_digest.o  $(LIB_CFLAGS) -c $(SRC_D)/crypto/engine/tb_digest.c
...
$(O_SSL): $(SSLOBJ)
	if test -e $(O_SSL); then $(RM) $(O_SSL)
	$(MKLIB) $(O_SSL) $(SSLOBJ)
	$(RANLIB) $(O_SSL)

$(O_CRYPTO): $(CRYPTOOBJ)
	if test -e $(O_CRYPTO); then $(RM) $(O_CRYPTO)
